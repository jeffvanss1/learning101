...
(function (global) {
  ...
  const DICTS = {
    en: {
      ...
      'row.prev': 'Scroll back',
      'row.next': 'Scroll forward',
      'heading.menu': 'Menu',
      ...
      'feed.because': 'Because you watched',
      'feed.catEmpty': 'Nothing in this category yet.',
    ...
    id: {
      ...
      'row.prev': 'Geser ke belakang',
      'row.next': 'Geser ke depan',
      'heading.menu': 'Menu',
      ...
      'feed.loading': 'Memuat\u2026',
      'feed.catAll': 'Semua',
      'feed.continue': 'Lanjutkan menonton',
      'feed.because': 'Karena kamu menonton',
      'feed.catEmpty': 'Belum ada apa pun di kategori ini.',
    ...
    es: {
      ...
      'row.prev': 'Desplazar hacia atr\u00e1s',
      'row.next': 'Desplazar hacia delante',
      'heading.menu': 'Men\u00fa',
      ...
      'feed.catAll': 'Todo',
      'feed.continue': 'Seguir viendo',
      'feed.because': 'Porque viste',
      'feed.catEmpty': 'Todav\u00eda no hay nada en esta categor\u00eda.',
    ...
    fr: {
      ...
      'row.prev': 'Faire d\u00e9filer en arri\u00e8re',
      'row.next': 'Faire d\u00e9filer en avant',
      'heading.menu': 'Menu',
      ...
      'feed.catAll': 'Tout',
      'feed.continue': 'Reprendre',
      'feed.because': 'Parce que vous avez regard\u00e9',
      'feed.catEmpty': 'Rien dans cette cat\u00e9gorie pour l\u2019instant.',
    ...
    pt: {
      ...
      'row.prev': 'Rolar para tr\u00e1s',
      'row.next': 'Rolar para frente',
      'heading.menu': 'Menu',
      'heading.library': 'Biblioteca',
      'action.join': 'Entrar',
      ...
      'feed.catAll': 'Tudo',
      'feed.continue': 'Continuar assistindo',
      'feed.because': 'Porque voc\u00ea assistiu',
      'feed.catEmpty': 'Ainda n\u00e3o h\u00e1 nada nesta categoria.',
    ...
    ar: {
      ...
      'row.prev': '\u062a\u0645\u0631\u064a\u0631 \u0644\u0644\u062e\u0644\u0641',
      'row.next': '\u062a\u0645\u0631\u064a\u0631 \u0644\u0644\u0623\u0645\u0627\u0645',
      ...
      'feed.catAll': '\u0627\u0644\u0643\u0644',
      'feed.continue': '\u0645\u062a\u0627\u0628\u0639\u0629 \u0627\u0644\u0645\u0634\u0627\u0647\u062f\u0629',
      'feed.because': '\u0644\u0623\u0646\u0643 \u0634\u0627\u0647\u062f\u062a',
      'feed.catEmpty': '\u0644\u0627 \u064a\u0648\u062c\u062f \u0634\u064a\u0621 \u0641\u064a \u0647\u0630\u0647 \u0627\u0644\u0641\u0626\u0629 \u0628\u0639\u062f.',
