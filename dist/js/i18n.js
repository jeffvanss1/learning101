...
(function (global) {
  ...
  const DICTS = {
    ...
    es: {
      ...
      'subs.tapSync': 'Sincronizar con un toque',
    ...
    fr: {
      ...
      'subs.tapSync': 'Synchro en un geste',
    ...
    pt: {
      ...
      'subs.tapSync': 'Sincronizar com um toque',
